...
final class TemplateVoter extends Voter
{
    ...
    protected function supports(string $attribute, $subject): bool
    {
        ...
        return $subject instanceof Template && \in_array($attribute, [self::SHOW, self::EDIT, self::DELETE], true);
    }

    /**
     * @param Template $post
     */
    protected function voteOnAttribute(string $attribute, $template, TokenInterface $token): bool
    {
        $user = $token->getUser();
        ...
        // return $user === $template->getAuthor();
        return true;
    }
}
